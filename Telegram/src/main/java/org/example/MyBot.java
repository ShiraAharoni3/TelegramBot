...
public class MyBot extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update)
    {
        ...
        if (update.hasMessage() && update.getMessage().hasText())
        {
            ...
            {
                Message math = update.getMessage();
                String response = math.getText();
                try
                {
                    String trivia = numbersInformation(response , "math");
                    sendMessageToUser(chatId, trivia) ;
                    lead.setApiRequest(chatId);
                    response = "" ;
                }
            ...
            {
                Message capital = update.getMessage();
                String response = capital.getText();
                try
                {
            ...
            {
                Message Subregion = update.getMessage();
                String response = Subregion.getText();
                try
                {
            ...
            {
                Message population = update.getMessage();
                String response = population.getText();
                try
                {
        ...
        if (update.hasCallbackQuery())
        {
            ...
            else if (lead.isNumbersInformation() )
            {
                ...
                //sendOptionToUser(chatId, Utils.TRIVIA, Utils.MATH, Utils.DATE, Utils.YEAR);
    ...
    private void sendOptionToUser (long chatId , String value1  , String value2 , String value3 , String value4 )
    {
    ...
    public static long Population (List<CountryModel> countryModels)
    {
        long population = 0 ;
    ...
    public static String Subregion (List<CountryModel> countryModels)
    {
    ...
    public static String Region (List<CountryModel> countryModels)
    {
        String region = null ;
        for (CountryModel country : countryModels) {
    ...
    public static String Capital (List<CountryModel> countryModels)
    {
        String capital = null ;
        for (CountryModel country : countryModels) {
    ...
    public static List<CountryModel> countryInformation(String countryName) throws Exception {
    ...
    public static String joke(String category) throws Exception {
        String joke = null;
        try {
    ...
    public String numbersInformation(String number, String type) throws Exception {
